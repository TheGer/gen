...
$('.search-form form').submit(function(){
	$('#opthalmologicalmicroperimetrytestfile-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Opthalmologicalmicroperimetrytestfiles</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'opthalmologicalmicroperimetrytestfile-grid',
