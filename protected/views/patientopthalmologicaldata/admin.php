...
$this->menu=array(
	...
	array('label'=>'Create Phenotype Data', 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$('#patientopthalmologicaldata-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'patientopthalmologicaldata-grid',
