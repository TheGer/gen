...
<div class="view">
	...
	<?php echo CHtml::link('Delete',"#", array("submit"=>array('/patientpedigreefile/delete', 'id'=>$data->id), 'confirm' => 'Are you sure?')); ?>
        <?php echo CHtml::link(CHtml::encode("Download File"), array('/patientpedigreefile/download', 'id'=>$data->id)); ?>
	<br />
