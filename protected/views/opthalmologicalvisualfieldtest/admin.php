...
$('.search-form form').submit(function(){
	$('#opthalmologicalvisualfieldtest-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Opthalmologicalvisualfieldtests</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'opthalmologicalvisualfieldtest-grid',
	...
	'columns'=>array(
		...
		'notperformedcomment',
		'centralsensitivity',
		'preservedcentralzone',
		'preservedislandinperiphery',
		'blindspot',
		*/
		array(
			'class'=>'CButtonColumn',
