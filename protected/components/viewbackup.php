...
<table border="1">
<?php
if (!empty($model->opthalmologicalcolorvisiontests)) {
?>
 ...
 $counter = 0;
 $eye='any';
 foreach ($model->opthalmologicalcolorvisiontests as $colorvisionmodel) {
     $counter++;
     $eye = $colorvisionmodel->eye;
        ?>
        <td valign='top'>
            <p><?php echo strtoupper($eye); ?></p>
            <?php $this->renderPartial('/opthalmologicalcolorvisiontest/_form', array('model' => $colorvisionmodel, 'action' => 'update'));?>
        </td>
 <?php }
 //only left eye filled
    if (($counter==1) && ($eye=='right')) {?><td valign='top'>
      <?php echo strtoupper($eye); ?>
        <?php 
    $colorvisionmodelleft = new Opthalmologicalcolorvisiontest;
    $colorvisionmodelleft->testid = $model->id;
    $colorvisionmodelleft->eye = 'left';
    $this->renderPartial('/opthalmologicalcolorvisiontest/_form', array('model' => $colorvisionmodelleft, 'action' => 'create')); ?> </td> 
        <?php }
   //only right eye filled
     if (($counter==1) && ($eye=='left')) {?><td valign='top'>
        <?php echo strtoupper($eye); ?>
         <?php
      $colorvisionmodelright = new Opthalmologicalcolorvisiontest;
       $colorvisionmodelright->testid = $model->id;
       $colorvisionmodelright->eye = 'right';
     $this->renderPartial('/opthalmologicalcolorvisiontest/_form', array('model' => $colorvisionmodelright, 'action' => 'create')); ?> </td><?php }
    ?>
   ...
   <?php    
    ...
    <td valign='top'>
     <?php echo strtoupper($eye); ?>
    <?php $this->renderPartial('/opthalmologicalcolorvisiontest/_form', array('model' => $colorvisionmodelright, 'action' => 'create')); ?>
    </td>
    <td valign='top'>
     <?php echo strtoupper($eye); ?>
    <?php $this->renderPartial('/opthalmologicalcolorvisiontest/_form', array('model' => $colorvisionmodelleft, 'action' => 'create')); ?>    
    </td>
    <?php
}
?>
...
<!--------------------------------------------- END TEST ONE ---------------------------------------------------->
<?php
    Yii::app()->clientScript->registerScript('showColorVision', "
$('.colorvision-button').click(function(){
alert('hello');
	$('#opthalmologicalcolorvisiontest2-formleft').toggle();
        $('#opthalmologicalcolorvisiontest2-formright').toggle();
	return false;
});",CClientScript::POS_READY);
 ?>
<?php echo CHtml::link('Show/hide another color vision test','#',array('class'=>'colorvision-button')); ?>

<table border="1">
<?php
if (!empty($model->opthalmologicalcolorvisiontests2)) {
?>
 ...
 $counter = 0;
 $eye='any';
 foreach ($model->opthalmologicalcolorvisiontests2 as $colorvisionmodel) {
     $counter++;
     $eye = $colorvisionmodel->eye;
        ?>
        <td valign='top'>
            <p><?php echo strtoupper($eye); ?></p>
            <?php $this->renderPartial('/opthalmologicalcolorvisiontest2/_form', array('model' => $colorvisionmodel, 'action' => 'update'));?>
        </td>
 <?php }
 //only left eye filled
    if (($counter==1) && ($eye=='right')) {?><td valign='top'>
     <?php echo strtoupper($eye); ?>
        <?php 
    $colorvisionmodelleft = new Opthalmologicalcolorvisiontest2;
    $colorvisionmodelleft->testid = $model->id;
    $colorvisionmodelleft->eye = 'left';
    $this->renderPartial('/opthalmologicalcolorvisiontest2/_form', array('model' => $colorvisionmodelleft, 'action' => 'create')); ?> </td> 
        <?php }
   //only right eye filled
     if (($counter==1) && ($eye=='left')) {?><td valign='top'>
       <?php echo strtoupper($eye); ?>
         <?php
      $colorvisionmodelright = new Opthalmologicalcolorvisiontest2;
       $colorvisionmodelright->testid = $model->id;
       $colorvisionmodelright->eye = 'right';
     $this->renderPartial('/opthalmologicalcolorvisiontest2/_form', array('model' => $colorvisionmodelright, 'action' => 'create')); ?> </td><?php }
    ?>
   ...
   <?php    
    ...
    <td valign='top'>
     <?php echo strtoupper($eye); ?> 
    <?php $this->renderPartial('/opthalmologicalcolorvisiontest2/_form', array('model' => $colorvisionmodelright, 'action' => 'create')); ?>
    </td>
    <td valign='top'>
    <?php echo strtoupper($eye); ?>
    <?php $this->renderPartial('/opthalmologicalcolorvisiontest2/_form', array('model' => $colorvisionmodelleft, 'action' => 'create')); ?>    
    </td>
    <?php
}
?>
