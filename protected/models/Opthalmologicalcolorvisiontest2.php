...
/**
 * This is the model class for table "opthalmologicalcolorvisiontest2".
 *
 * The followings are the available columns in table 'opthalmologicalcolorvisiontest2':
 * @property integer $id
 ...
 */
class Opthalmologicalcolorvisiontest2 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Opthalmologicalcolorvisiontest2 the static model class
	 */
	...
	{
		return 'opthalmologicalcolorvisiontest2';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, testid, eye, performed, type, confusionindex, angle, notperformedcomment, other', 'safe', 'on'=>'search'),
		);
	}
